...
class HomeFragment : Fragment() {
    ...
    lateinit var rvProdukbalesemi: RecyclerView
    lateinit var rvProdukmaggot: RecyclerView
    lateinit var rvInternet: RecyclerView
    ...
    fun displayProduk() {
        ...
        arrSlider.add(R.drawable.ksmbalesemi)
        arrSlider.add(R.drawable.bcv)
        arrSlider.add(R.drawable.maggot)
        ...
        rvProdukbalesemi.adapter = AdapterProduk(requireActivity(), listProduk)
        rvProdukbalesemi.layoutManager = layoutManager

        rvProdukmaggot.adapter = AdapterProduk(requireActivity(), listProduk)
        rvProdukmaggot.layoutManager = layoutManager2

        rvInternet.adapter = AdapterProduk(requireActivity(), listProduk)
        rvInternet.layoutManager = layoutManager3
    }
    ...
    fun init(view: View) {
        ...
        rvProdukbalesemi = view.findViewById(R.id.rv_produkbalesemi)
        rvProdukmaggot = view.findViewById(R.id.rv_produkmaggot)
        rvInternet = view.findViewById(R.id.rv_produkinternet)
    }
